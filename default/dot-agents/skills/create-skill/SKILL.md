---
name: create-skill
description: Guides users through creating effective Agent Skills for OpenCode. Use when you want to create, write, or author a new skill, or asks about skill structure, best practices, or SKILL.md format.
---

# Creating Skills in OpenCode

This skill guides you through creating effective Agent Skills for OpenCode. Skills are markdown files that teach the agent how to perform specific tasks: reviewing PRs using team standards, generating commit messages in a preferred format, querying database schemas, or any specialized workflow.
...
This location is part of the dotfiles repository and will be synced across all your projects.
