...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --source-dir DIR   Remote source directory (default: ~/Code/DRL_RDE/data/studies)"
            echo "  --target-dir DIR   Local target directory (default: same as source directory)"
